...
#if BABEL
     internal sealed partial class TinyCScanner : ScanBase, IColorScan
    {
...
#else  // BABEL
	internal sealed partial class TinyCScanner : ScanBase
	{
		private ScanBuff buffer;
		int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
		internal TinyCScanner(Stream file)
		{
			SetSource(file); // no unicode option
		}
#endif // !NOFILES

		internal TinyCScanner() { }
